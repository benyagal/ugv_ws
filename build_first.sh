...
colcon build --symlink-install --packages-select ugv_uwb_localization dwm1001_driver dwm1001_transform dwm1001_launch dwm1001_visualization
colcon build --packages-select ugv_bringup ugv_chat_ai ugv_description ugv_gazebo ugv_gripper ugv_nav ugv_slam ugv_tools ugv_vision ugv_web_app --symlink-install 
